...
plan2 = Automator(plan1)

if plan2.found: #It found a matching file!
    plan2 = ParserSpawner(plan2.found)
    plan2 = plan2.spawnParser(plan2.txMachine)

else: #It failed to find a matching file!
...
# Capture the standard output for logging
output = io.StringIO()
sys.stdout = output
...
if plan1==plan2:
    messagebox.showinfo("Success", "Integrity Check Passed!")
else:
    messagebox.showinfo("Failure", "Integrity Check Failed!")
