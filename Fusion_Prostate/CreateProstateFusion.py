...
# Import classes
from FusionPopupProstate import FusionPopupProstate
...
class CreateProstateFusion:
    ...
    def get_exam(self,exam_name):
        ...
        if exam.PatientPosition != "HFS":
            title = "Error"
            message = f"{exam.EquipmentInfo.Modality} series is not HFS patient position.  Not currently supported."
