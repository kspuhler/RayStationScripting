...
script_dir = r"\\Client\F$\SHARING\Radiation Oncology Physics\RaystationScriptingDEVEL\GenericClasses"
...
await_user_input(message='Verify the selected open fields copied to your plan with correct Jaws and conformed MLCs.  Then, hit the Script execution play button.')
