...
class SelectUIObjConstraints:
    ...
    def __init__(self, plan_name, beam_set_name):
        ...
        self.tab_control = "Objectives/constraints"
        self.tab_item = "Objectives/constraints"
        ...
        try:
            ...
            # Select tab item
            self.ui.Workspace.TabControl[self.tab_control].TabItem[self.tab_item].Select()
            print(f"Selected tab control: {self.tab_control}")
            print(f"Selected tab item: {self.tab_item}")
...
# window_and_tab = SelectUIObjConstraints(plan.Name, beam_set.DicomPlanLabel)
