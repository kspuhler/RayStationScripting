...
#'F:\\SHARING\\Radiation Oncology Physics\\RaystationScriptingPROD\\AutoPlanningBeta\\Pipelines\\Published'
...
class JH_Prostate_Nodes_4500(Pipeline):
    ...
    _PARAMS = {**Pipeline._PARAMS,
              ...
              'STRUCTURE_TEMPLATE': {'Name': "PLAN TEMPLATE: JH ProstLN 4500", 
                                     'Structures': ["PTV4500", "Bladder", "Rectum", "Lt Femoral", "Rt Femoral", "PTVn", "PTVp",  "Bladder - GTVp", "Spacer", 
