# -*- coding: utf-8 -*-
"""
Created on Tue Feb  4 12:33:18 2025
...
from Planning.Structures.Templates.deepLearningSegmentationDictionaries import TamHeadAndNeck, TamAbdomen, SolanBreast
...
class AutoSegmentationTemplate(ScriptObject):
    ...
    def __init__(self, templateDictionary, verboseExecution=False, runPreChecks=True):
        ...
        for modelName, roiDict in self.templateDictionary.items():
            print(modelName)
            print(roiDict)
            self.exam.RunDeepLearningSegmentationWithCustomRoiNames(ExaminationsAndRegistrations={self.exam.Name: None }, ModelAndRoiNames= {modelName: roiDict})
    ...
    def preChecks(self):
        ...
        self.roisToContour = [value for subdict in self.templateDictionary.values() for value in subdict.values()]
...
class SolanTemplate(AutoSegmentationTemplate):
    
    def __init__(self, templateDictionary = SolanBreast):
        print(templateDictionary)
        print(type(templateDictionary))
