"""
tps_qa\tps_annual_qa.py

Front-end to run tps_annual_qa.py 
...
# === Local imports ===
from tps_qa.main_tps_annual_qa import TPSAnnualQA
...
def main() -> None:
    ...
    try:
        ...
        pass
    try:
        tps_annual = TPSAnnualQA()
        tps_annual.main()
    except Exception as e:
        _logger.error("[FAILED] TPS Annual QA: %s", str(e))
    _logger.info("\n\n===== Finished TPS Annual QA =====\n\n") 
