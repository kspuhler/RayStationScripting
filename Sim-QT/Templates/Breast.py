...
class Breast(SimTemplate):
    ...
    def addBeams(self):
        ...
        biPoint = self.beamSet.CreatePhotonBeam(BeamQualityId='6',  IsocenterData={ 'Position': { 'x': 0, 'y': 0, 'z': 0 }, 'NameOfIsocenterToRef': 'BI_POINT', 'Name':'BI_POINT', 'Color': "3, 252, 252" }, 
                                          Name = 'BI_POINT', GantryAngle = 0, CollimatorAngle = 0)

        pin = self.beamSet.CreatePhotonBeam(BeamQualityId='6',  IsocenterData={ 'Position': { 'x': 0, 'y': 0, 'z': 0 }, 'NameOfIsocenterToRef': 'pin', 'Name':'PIN', 'Color': "252, 3, 236" }, 
                                          Name = 'PIN', GantryAngle = 0, CollimatorAngle = 0)
