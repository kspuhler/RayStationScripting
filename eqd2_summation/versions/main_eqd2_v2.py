...
from EQD2_Summation.ui_eqd2_v2 import EQD2SelectionWindow
...
if _ALERT_PHYSICIST_ON_ALL_USES:
    ...
    e = RuntimeError("INFO ONLY - EQD2 script initialized.  Review patient data in logs and summation in Raystation.")
...
class EQD2DoseSummation():
    ...
    def _assign_target_ct_exam_names(self):
        ...
        try:
            ...
            _logger.error("[FAILED] inside _assign_target_ct_exam_names(): %s", str(e))
            self._abort_script_error(exc=e, message="Failed iniside _assign_target_ct_exam_names()")
        target_ct_exam_names = list(set(target_ct_exam_names))
        _logger.debug("Targe CT names for deformable registration: %s", target_ct_exam_names)
    ...
    def _find_non_photon_plans(self):
        try:
            ...
            _logger.warning("[WARNING] to notify user to change to photon plan: %s", str(e))
    ...
    def _create_external_contour(self):
        ...
        try:
            ...
            _logger.warning("[WARNING] in _create_external_contour(): %s", str(e))
    ...
    def _update_dose_statistics(self):
        ...
        try:
            ...
            _logger.warning("[WARNING] to update dose statistics.")
    ...
    def _create_sum_plan(self):
        ...
        try:
            ...
            if plan_name_to_copy:
                ...
                _logger.info("No plan exists on the selected reference CT. Creating sum plan will be skipped.")
        except Exception as e:
    ...
    def main(self):
        ...
        try:
            ...
            if values is None:    
                _logger.info("EQD2 UI returned no values. Script will be ended...")
                return                          
            ...
            _logger.error("[FAILED] in main_eqd2.py.  Email notification sent.")
